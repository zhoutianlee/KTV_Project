...
__align(4) 
uint8_t Rx_Buff[ETH_RXBUFNB][ETH_RX_BUF_SIZE]__attribute__((at(SDRAM_BANK_ADDR_S1))); /* Ethernet Receive Buffer */
__align(4) 
uint8_t Tx_Buff[ETH_TXBUFNB][ETH_TX_BUF_SIZE]__attribute__((at(SDRAM_BANK_ADDR_S1 + sizeof(Rx_Buff)))); /* Ethernet Transmit Buffer */

//__align(4) 
//ETH_DMADESCTypeDef  DMARxDscrTab1[ETH_RXBUFNB];/* Ethernet Rx MA Descriptor */
//__align(4) 
//ETH_DMADESCTypeDef  DMATxDscrTab1[ETH_TXBUFNB];/* Ethernet Tx DMA Descriptor */
//__align(4) 
//uint8_t Rx_Buff1[ETH_RXBUFNB][ETH_RX_BUF_SIZE];//__attribute__((at(SDRAM_BANK_ADDR_S1 + sizeof(Rx_Buff)*2))); /* Ethernet Receive Buffer */
//__align(4) 
//uint8_t Tx_Buff1[ETH_TXBUFNB][ETH_TX_BUF_SIZE];//__attribute__((at(SDRAM_BANK_ADDR_S1 + sizeof(Rx_Buff)*3))); /* Ethernet Transmit Buffer */

//__align(4) 
//ETH_DMADESCTypeDef  DMARxDscrTab2[ETH_RXBUFNB];/* Ethernet Rx MA Descriptor */
//__align(4) 
//ETH_DMADESCTypeDef  DMATxDscrTab2[ETH_TXBUFNB];/* Ethernet Tx DMA Descriptor */
//__align(4) 
//uint8_t Rx_Buff2[ETH_RXBUFNB][ETH_RX_BUF_SIZE];//__attribute__((at(SDRAM_BANK_ADDR_S1 + sizeof(Rx_Buff)*4))); /* Ethernet Receive Buffer */
//__align(4) 
//uint8_t Tx_Buff2[ETH_TXBUFNB][ETH_TX_BUF_SIZE];//__attribute__((at(SDRAM_BANK_ADDR_S1 + sizeof(Rx_Buff)*5))); /* Ethernet Transmit Buffer */
