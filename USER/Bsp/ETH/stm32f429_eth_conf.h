...
#ifdef USE_Delay
  #include "Bsp/bsp.h"    /* Header file where the Delay function prototype is exported */
...
/* Redefinition of the Ethernet driver buffers size and count */
 ...
 #define ETH_RXBUFNB        100//400                    /* 4 Rx buffers of size ETH_RX_BUF_SIZE */
 #define ETH_TXBUFNB        100//400                    /* 4 Tx buffers of size ETH_TX_BUF_SIZE */
#endif
