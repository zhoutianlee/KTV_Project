...
#define SDRAM_BANK_ADDR_S0	 ((uint32_t)0xD0000000)
#define SDRAM_BANK_ADDR_S1	 ((uint32_t)0xD0100000)
#define SDRAM_BANK_ADDR_S2	 ((uint32_t)0xD0300000)
#define SDRAM_BANK_ADDR_S3	 ((uint32_t)0xD0500000)
#define SDRAM_BANK_ADDR_S4	 ((uint32_t)0xD0800000)
